defmodule Blueprint.Typed do

    defmacro __using__(_) do
        quote do
            import Blueprint.Typed, only: [blueprint: 1, blueprint: 2]
        end
    end

    defmacro blueprint(opts\\[], do: block) do
        quote do
            Blueprint.Typed.__define__(
    ...
    defmacro __define__(block, opts) do
        quote do
            ...
            Blueprint.Typed.__type__(@bp_types, unquote(opts))

            Blueprint.Typed.__contructor__(@bp_keys)
