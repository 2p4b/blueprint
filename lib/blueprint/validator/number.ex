defmodule Blueprint.Validator.Number do
    @moduledoc """
    ...
    * `:allow_blank`: A boolean whether to skip this validaton for blank values.
    ...
    Examples when using the `:is` option:
        ...
        iex> Blueprint.Validator.Number.validate("not_a_number", is: true)
        {:error, "must be a number"}

        iex> Blueprint.Validator.Number.validate(3.14, is: true)
        {:ok, 3.14}

        iex> Blueprint.Validator.Number.validate("not_a_number", is: false)
        {:ok, 3.14}

        iex> Blueprint.Validator.Number.validate(3.14, is: false)
        {:error, "must not be a number"}

    Examples when using the boolean value in options for the `:is` option:

        iex> Blueprint.Validator.Number.validate("not_a_number", true)
        {:error, "must be a number"}

        iex> Blueprint.Validator.Number.validate(3.14, true)
        {:ok, 3.14}

        iex> Blueprint.Validator.Number.validate("not_a_number", false)
        {:ok, "not_a_number"}

        iex> Blueprint.Validator.Number.validate(3.14, false)
        {:error, "must not be a number"}

    Examples when using the `:equal_to` option:

        iex> Blueprint.Validator.Number.validate(3.14, equal_to: 1.41)
        {:error, "must be a number equal to 1.41"}

        iex> Blueprint.Validator.Number.validate(3.14, equal_to: 3.14)
        {:ok, 3.14}

        iex> Blueprint.Validator.Number.validate(3.14, equal_to: 6.28)
        {:error, "must be a number equal to 6.28"}

    Examples when using the `:greater_than` option:

        iex> Blueprint.Validator.Number.validate(3.14, greater_than: 1.41)
        {:ok, 3.14}

        iex> Blueprint.Validator.Number.validate(3.14, greater_than: 3.14)
        {:error, "must be a number greater than 3.14"}

        iex> Blueprint.Validator.Number.validate(3.14, greater_than: 6.28)
        {:error, "must be a number greater than 6.28"}

    Examples when using the `:greater_than_or_equal_to` option:

        iex> Blueprint.Validator.Number.validate(3.14, greater_than_or_equal_to: 1.41)
        {:ok, 3.14}

        iex> Blueprint.Validator.Number.validate(3.14, greater_than_or_equal_to: 3.14)
        {:ok, 3.14}

        iex> Blueprint.Validator.Number.validate(3.14, greater_than_or_equal_to: 6.28)
        {:error, "must be a number greater than or equal to 6.28"}

    Examples when using the `:less_than` option:

        iex> Blueprint.Validator.Number.validate(3.14, less_than: 1.41)
        {:error, "must be a number less than 1.41"}

        iex> Blueprint.Validator.Number.validate(3.14, less_than: 3.14)
        {:error, "must be a number less than 3.14"}

        iex> Blueprint.Validator.Number.validate(3.14, less_than: 6.28)
        {:ok, 3.14}

    Examples when using the `:less_than_or_equal_to` option:

        iex> Blueprint.Validator.Number.validate(3.14, less_than_or_equal_to: 1.41)
        {:error, "must be a number less than or equal to 1.41"}

        iex> Blueprint.Validator.Number.validate(3.14, less_than_or_equal_to: 3.14)
        {:ok, 3.14}

        iex> Blueprint.Validator.Number.validate(3.14, less_than_or_equal_to: 6.28)
        {:ok, 3.14}

    Examples when using the combinations of the above options:

        iex> Blueprint.Validator.Number.validate("not_a_number", is: true, greater_than: 0, less_than_or_equal_to: 3.14)
        {:error, "must be a number"}

        iex> Blueprint.Validator.Number.validate(0, is: true, greater_than: 0, less_than_or_equal_to: 3.14)
        {:error, "must be a number greater than 0"}

        iex> Blueprint.Validator.Number.validate(1.41, is: true, greater_than: 0, less_than_or_equal_to: 3.14)
        {:ok, 1.41}

        iex> Blueprint.Validator.Number.validate(3.14, is: true, greater_than: 0, less_than_or_equal_to: 3.14)
        {:ok, 3.14}

        iex> Blueprint.Validator.Number.validate(6.28, is: true, greater_than: 0, less_than_or_equal_to: 3.14)
    ...
    Custom error messages (in EEx format), provided as :message, can use the following values:
        ...
        iex> Blueprint.Validator.Number.__validator__(:message_fields)
        [
            value: "Bad value",
            is: "Is number",
