defmodule Blueprint.Validators.Uuid do
    @moduledoc """
    ...
    * `false`: Is the same as the `[format: :not_any]` options.
    ...
    Examples when using the `:any` or `true` options:
        ...
        iex> Blueprint.Validators.Uuid.validate("02aa7f48-3ccd-11e4-b63e-14109ff1a304", format: :any)
        :ok

        iex> Blueprint.Validators.Uuid.validate("02aa7f48-3ccd-11e4-b63e-14109ff1a30", format: :any)
        {:error, "must be a valid UUID string"}

        iex> Blueprint.Validators.Uuid.validate("02aa7f48-3ccd-11e4-b63e-14109ff1a304", true)
        :ok

        iex> Blueprint.Validators.Uuid.validate("02aa7f48-3ccd-11e4-b63e-14109ff1a30", true)
        {:error, "must be a valid UUID string"}

    Examples when using the `:not_any` or `false` options:

        iex> Blueprint.Validators.Uuid.validate("not_a_uuid", format: :not_any)
        :ok

        iex> Blueprint.Validators.Uuid.validate("02aa7f48-3ccd-11e4-b63e-14109ff1a304", format: :not_any)
        {:error, "must not be a valid UUID string"}

        iex> Blueprint.Validators.Uuid.validate("not_a_uuid", false)
        :ok

        iex> Blueprint.Validators.Uuid.validate("02aa7f48-3ccd-11e4-b63e-14109ff1a304", false)
        {:error, "must not be a valid UUID string"}

    Examples when using the `:default` option:

        iex> Blueprint.Validators.Uuid.validate("02aa7f48-3ccd-11e4-b63e-14109ff1a304", format: :default)
        :ok

        iex> Blueprint.Validators.Uuid.validate("02aa7f483ccd11e4b63e14109ff1a304", format: :default)
        {:error, "must be a valid UUID string in default format"}

    Examples when using the `:hex` option:

        iex> Blueprint.Validators.Uuid.validate("02aa7f483ccd11e4b63e14109ff1a304", format: :hex)
        :ok

        iex> Blueprint.Validators.Uuid.validate("urn:uuid:02aa7f48-3ccd-11e4-b63e-14109ff1a304", format: :hex)
        {:error, "must be a valid UUID string in hex format"}

    Examples when using the `:urn` option:

        iex> Blueprint.Validators.Uuid.validate("urn:uuid:02aa7f48-3ccd-11e4-b63e-14109ff1a304", format: :urn)
        :ok

        iex> Blueprint.Validators.Uuid.validate("02aa7f48-3ccd-11e4-b63e-14109ff1a304", format: :urn)
    ...
    Custom error messages (in EEx format), provided as `:message`, can use the following values:
        ...
        iex> Blueprint.Validators.Uuid.__validator__(:message_fields)
        [value: "Bad value", format: "The UUID format"]

    An example:

        iex> Blueprint.Validators.Uuid.validate("not_a_uuid", format: :any,
